  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'patient': (
      <div key="patient" className="space-y-1.5">
        ...
        <Combobox
          id="patient"
          placeholder="Welcher Patient kommt?"
    ...
    'behandler': (
      <div key="behandler" className="space-y-1.5">
        ...
        <Combobox
          id="behandler"
          placeholder="Wer führt Termin durch?"
    ...
    'rezept': (
      <div key="rezept" className="space-y-1.5">
        ...
        <Combobox
          id="rezept"
          placeholder="Welches Rezept (optional)?"
    ...
    'beginn': (
      <div key="beginn" className="space-y-1.5">
        ...
        <DatePicker
          id="beginn"
          placeholder="Wann startet die Behandlung?"
          mode="datetime"
    ...
    'ende': (
      <div key="ende" className="space-y-1.5">
        ...
        <DatePicker
          id="ende"
          placeholder="Wann endet die Behandlung?"
          mode="datetime"
