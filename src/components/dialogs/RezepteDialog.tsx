  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'arztpraxis': (
      <div key="arztpraxis" className="space-y-1.5">
        ...
        <Input
          id="arztpraxis"
          placeholder="z. B. Praxis Dr. Weber"
    ...
    'diagnose': (
      <div key="diagnose" className="space-y-1.5">
        ...
        <Textarea
          id="diagnose"
          placeholder="Diagnose und Indikation..."
    ...
    'leistung': (
      <div key="leistung" className="space-y-1.5">
        ...
        <Combobox
          id="leistung"
          placeholder="Welche Leistung verordnet?"
    ...
    'gueltig_bis': (
      <div key="gueltig_bis" className="space-y-1.5">
        ...
        <DatePicker
          id="gueltig_bis"
          placeholder="Wann Rezept ungültig?"
          mode="date"
