...
// <custom:intent-imports>
import { IconCalendarPlus, IconNotes } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-termin', label: { de: 'Neuer Termin', en: 'New appointment' }, icon: IconCalendarPlus, description: 'Termin in 3 Schritten anlegen: Patient, Behandler und Zeitfenster wählen' },
  { path: '/intents/behandlung-dokumentieren', label: { de: 'Behandlung dokumentieren', en: 'Document treatment' }, icon: IconNotes, description: 'Durchgeführte Behandlung nach einem Termin dokumentieren' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-15T14:52:33+00:00';
