...
const APPGROUP_ID = '6aa95b9addc6cd0631336451';
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/rezept-erfassen" element={<Suspense fallback={<DashboardSkeleton />}><IntentRezeptErfassenPage /></Suspense>} />
                {/* </custom:routes> */}
